...
module.exports = grammar({
	...
	rules: {
		...
		sep_next: $ => ',',
		statement_return: $ => seq('R','E','T','U','R','N'),
		statement_gosub: $ => seq('G','O','S','U','B'),
		statement_rem: $ => prec(1,seq('R','E','M')),
		statement_let: $ => prec(1,seq('L','E','T')),
		...
		op_eq_assign_int: $ => '=',
		close: $ => ')',
		statement_list_line: $ => seq('L','I','S','T'),
		sep_list: $ => ',',
		statement_list: $ => seq('L','I','S','T'),
		statement_pop: $ => seq('P','O','P'),
		statement_nodsp_str: $ => seq('N','O','D','S','P'),
		statement_nodsp_int: $ => seq('N','O','D','S','P'),
		statement_notrace: $ => seq('N','O','T','R','A','C','E'),
		statement_dsp_str: $ => seq('D','S','P'),
		statement_dsp_int: $ => seq('D','S','P'),
		statement_trace: $ => seq('T','R','A','C','E'),
